...
class FocusscoreStatistics extends StatelessWidget {
  const FocusscoreStatistics({super.key});
  @override
            ...
            body: GetBuilder<ReactionTimeListController>(
                ...
                builder: (controller) {
                  return SizedBox(
                    ...
                    child: Column(
                      children: [
                        widgetAppBar(title: 'Focusscore Statistics'),
                        Text('focusscore Stats Screen'),
                      ],
                    ),
                  );
                })));
