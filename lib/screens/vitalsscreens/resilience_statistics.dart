...
class ResilienceStatistics extends StatelessWidget {
  const ResilienceStatistics({super.key});
  @override
            ...
            body: GetBuilder<ReactionTimeListController>(
                ...
                builder: (controller) {
                  return SizedBox(
                    ...
                    child: Column(
                      children: [
                        widgetAppBar(title: 'Resilience Statistics'),
                        Text('resilience Stats Screen'),
                      ],
                    ),
                  );
                })));
